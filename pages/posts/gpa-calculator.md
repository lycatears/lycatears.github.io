...
## 下载
[百度网盘](https://pan.baidu.com/s/1g5dltdF0NjIiTbh2MlTqNQ?pwd=vj2y)

由于蓝奏云100MB限制，只能提供百度网盘链接，非常抱歉。

- 🎉 20260708 更新：
1. 新增1.2.77版本计算器
2. 添加【导入预设】文件夹，下载自己需要的脚本，然后替换`config`目录下的`import.js`即可
...
1. 修复手动添加的成绩绩点总为0的bug
2. 新增软件学院保研科目预设脚本，使用该脚本导入的成绩去除了非保研科目的成绩，以及重修成绩
3. 兼容树洞导出的json格式
4. 优化部分UI布局细节
