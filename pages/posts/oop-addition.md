...
### 答案（不唯一）
实际问题：人使用手机。A类代表人类，其派生类代表不同职业的人；D类代表手机，其派生类表示不同的手机品牌。例如，A代表人类，B代表工人，C代表农民，D代表手机，E代表华为手机，F代表小米手机，f代表人浏览手机内容，g代表手机显示内容。
...
```
> 注：我是按照原题的题号顺序排列的代码，但是这样会出现编译错误。个人认为4，5空应该在3的前面。
## 单例模式/多例模式
