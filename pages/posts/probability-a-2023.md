...
10. 设在每次试验中，事件 $A$ 发生的概率是$0.8$，用 $X$ 表示 $1000$ 次独立试验中事件 $A$ 发生的次数，根据切比雪夫不等式，有 $P\{760<X<840\}=\underline{\hspace{4em}}$.

11. 设总体 $X\sim N(\mu,3^2)$，要使未知参数 $\mu$ 的置信区间的长度 $L\le 2$，样本容量 $n$ 至少为 $\underline{\hspace{4em}}$.
